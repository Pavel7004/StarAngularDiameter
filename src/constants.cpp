...
const double P1 = 5.0e11;  // Распределение яркости по диску звезды
const double P2 = 2.0e9;     // --//--
const double L0 = 2100.0;    // Фон неба
const double deltat = 2e-3;  // Шаг данных t (с)
const double V = 726.0;  // Скорость центра диска луны (м/с)
const double t0 = 112.4e-3;  // Время пересечения центра диска луны (с)
const double tN = 250e-3;  // Время наблюдений (с)
const double R0 =
