...
thread_local double t0 = 186.388e-3;  // Время пересечения центра диска луны (с)
thread_local double L0 = 2092.3;  // Фон неба
thread_local double B0 = 2.83e11;  // Яркость в центре диска луны
thread_local double R0 =
    3.214;  // Радиус проекции звезды на плоскость видимого диска луны (м)
